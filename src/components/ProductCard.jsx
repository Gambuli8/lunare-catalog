...
function getMaterialBadgeStyle(material = '') {
  ...
  return { bg: '#010101', text: '#fff' } // biyú
}
    ...
    >
      ...
      <div className='flex flex-col flex-1 p-5'>
        ...
        <div className='flex items-end justify-between mt-auto'>
          <div>
            <div className='font-serif text-[22px] font-medium text-[#0e0d0c] leading-none'>{formatPrice(product.price)}</div>
            <div className='text-[10px] text-[#7a7269] tracking-widest mt-0.5'>{product.priceNote === 'par' ? 'precio por par' : 'por unidad'}</div>
          </div>

        ...
        <div className='overflow-hidden'>
          <p className='text-[15px] leading-relaxed text-muted pb-5 max-w-2xl'>
            ...
            {link && (
              <>
                {' '}
                <a href={link.href} className='inline-flex items-center gap-1 min-h-[44px] text-gold hover:underline'>
                  {link.text}
  ...
  return (
    ...
    >
      ...
      <nav aria-label='Ruta de navegación' className='flex items-center gap-2 mb-6 text-xs tracking-wide text-muted'>
        <a href='/' className='inline-flex items-center min-h-[44px] transition-colors hover:text-gold'>Inicio</a>
        ...
        <p className='mt-10 text-sm text-muted'>
          ...
          <a
            ...
            target='_blank'
            rel='noopener noreferrer'
            className='inline-flex min-h-[44px] items-center gap-1 py-2 text-gold hover:underline'
          >
